...
public abstract class LoadingLayout extends FrameLayout implements
	...
	case PULL_FROM_END:
	    lp.gravity = scrollDirection == Orientation.VERTICAL ? Gravity.TOP
		    : Gravity.LEFT;
	    // Load in labels
	    mPullLabel = context.getString(R.string.pull_to_refresh_pull_up);
	    mRefreshingLabel = context
		    .getString(R.string.pull_to_refresh_loading_label);
	    mReleaseLabel = context
		    .getString(R.string.pull_to_refresh_release_up);
	    break;
